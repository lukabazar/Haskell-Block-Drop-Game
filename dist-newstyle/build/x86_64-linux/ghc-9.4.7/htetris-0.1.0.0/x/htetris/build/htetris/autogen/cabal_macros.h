...
/* package htetris-0.1.0.0 */
#ifndef VERSION_htetris
#define VERSION_htetris "0.1.0.0"
#endif /* VERSION_htetris */
#ifndef MIN_VERSION_htetris
#define MIN_VERSION_htetris(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_htetris */
...
#define CURRENT_COMPONENT_ID "htetris-0.1.0.0-inplace-htetris"
