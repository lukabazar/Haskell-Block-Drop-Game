...
--Construct Juns
consTetromino Jun1 l@(x,y) = Tetromino Jun1 p
...
consTetromino Jun2 l@(x,y) = Tetromino Jun2 p
                             $ map (flip Tile yellow)
                                   [ (x - 1,y - 1)
                                   , (x,y - 1)
                                   , p
...
consTetromino Jun3 l@(x,y) = Tetromino Jun3 p
                             $ map (flip Tile yellow)
                                   [ (x + 1,y - 1)
                                   , (x + 1,y)
                                   , p
...
consTetromino Jun4 l@(x,y) = Tetromino Jun4 p
                             $ map (flip Tile yellow)
                                  [ (x + 1,y + 1)
                                   , (x ,y + 1)
                                   , p
...
--Construct Loes
consTetromino Loe1 l@(x,y) = Tetromino Loe1 p
                             $ map (flip Tile green)
                                   [ (x - 1,y)
                                   , p
                                   , (x + 1,y)
...
consTetromino Loe2 l@(x,y) = Tetromino Loe2 p
                             $ map (flip Tile green)
                                   [ (x,y - 1)
                                   , p
                                   , (x,y + 1)
...
consTetromino Loe3 l@(x,y) = Tetromino Loe3 p
                             $ map (flip Tile green)
                                   [ (x + 1,y)
                                   , p
                                   , (x - 1,y)
...
consTetromino Loe4 l@(x,y) = Tetromino Loe4 p
                             $ map (flip Tile green)
                                   [ (x,y + 1)
                                   , p
                                   , (x,y - 1)
...
--Construct Sals
consTetromino Sal1 l@(x,y) = Tetromino Sal1 p
                             $ map (flip Tile blue)
                                   [ (x - 1,y)
                                   , p
                                   , (x,y +1)
...
consTetromino Sal2 l@(x,y) = Tetromino Sal2 p
                             $ map (flip Tile blue)
                                   [ (x,y - 1)
                                   , p
                                   , (x - 1,y)
...
--Construct Tams
consTetromino Tam1 l@(x,y) = Tetromino Tam1 p
...
consTetromino Tam2 l@(x,y) = Tetromino Tam2 p
                             $ map (flip Tile violet)
                                   [ (x,y - 1)
                                   , p
                                   , (x -1,y)
...
consTetromino Tam3 l@(x,y) = Tetromino Tam3 p
                             $ map (flip Tile violet)
                                   [ (x + 1,y)
                                   , p
                                   , (x,y - 1)
...
consTetromino Tam4 l@(x,y) = Tetromino Tam4 p
                             $ map (flip Tile violet)
                                   [ (x,y + 1)
                                   , p
                                   , (x + 1,y)
...
--Construct Zims
consTetromino Zim1 l@(x,y) = Tetromino Zim1 p
                             $ map (flip Tile red)
                                   [ (x - 1,y)
                                   , p
                                   , (x,y - 1)
...
consTetromino Zim2 l@(x,y) = Tetromino Zim2 p
                             $ map (flip Tile red)
                                   [ (x,y - 1)
                                   , p
                                   , (x + 1,y)
