...
instance Eq Tetromino where
  Tetromino a1 b1 c1 == Tetromino a2 b2 c2 =
    (a1 == a2)
      && (b1 == b2)
...
-- Spawn coordinates above the well
spawnLocale :: Coord
spawnLocale = (4, 20)
...
newGame tetroBag cs =
  Environment
    { currentTetromino = consTetromino (head tetroBag) spawnLocale,
